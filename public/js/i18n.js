...
const STRINGS = {
  ...
  'stage.follow': { pt: 'Seguir quem fala', en: 'Follow the speaker' },
  'stage.popout': { pt: 'Abrir em janela (P)', en: 'Pop out (P)' },
  'stage.popoutAria': { pt: 'Abrir em janela', en: 'Pop out' },
  'stage.poppedOut': { pt: 'O palco está numa janela separada.', en: 'The stage is in a separate window.' },
  'stage.dock': { pt: 'Trazer de volta', en: 'Bring it back' },
  'tile.live': { pt: 'AO VIVO', en: 'LIVE' },
  'tile.float': { pt: 'Desencaixar / encaixar', en: 'Undock / dock' },
  ...
  'menu.focus': { pt: 'Focar', en: 'Focus' },
  'menu.unfocus': { pt: 'Desfocar', en: 'Unfocus' },
  'menu.float': { pt: 'Desencaixar (mini janela)', en: 'Undock (mini window)' },
  'menu.dock': { pt: 'Encaixar de volta', en: 'Dock back' },
  'menu.popout': { pt: 'Abrir em janela', en: 'Pop out' },
  'menu.popin': { pt: 'Trazer a janela de volta', en: 'Bring the window back' },
  'menu.hideVideo': { pt: 'Ocultar vídeo (só pra você)', en: 'Hide video (just for you)' },
  'menu.showVideo': { pt: 'Mostrar vídeo', en: 'Show video' },
  'menu.mirror': { pt: 'Espelhar minha câmera', en: 'Mirror my camera' },
  'menu.hideSelf': { pt: 'Ocultar minha câmera pra mim', en: 'Hide my camera from me' },
